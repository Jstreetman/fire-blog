...
const Beam = ({ top, left, transition = {} }: BeamType) => {
  return (
    <motion.div
      ...
      className="absolute -z-20 h-[64px] w-[1px] bg-gradient-to-b from-blue-500/0 to-blue-500"
    />
  );
};
  ...
  return (
    ...
    >
      <div
        ...
        className="absolute inset-0  -z-20"
      />
      <div className="absolute inset-0  -z-20 bg-gradient-to-b from-zinc-950/0 to-zinc-950" />
    </motion.div>
  );
};
